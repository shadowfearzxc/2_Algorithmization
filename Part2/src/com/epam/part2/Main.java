...
public class Main {
  ...
  /*  public static void autofillArray(){
    ...
    private static void task17() {
        ...
        Scanner scanner = new Scanner(System.in);
        System.out.println("Enter the square matrix with even number n: "); int n = scanner.nextInt();
...
int CountString = 1;
    ...
    private static void task23() {
        ...
        boolean isSorted;
        Scanner scanner = new Scanner(System.in);
        System.out.print("Введите строки  "); int n = scanner.nextInt();
        System.out.print("Введите колонки "); int m = scanner.nextInt();
        int[][] matrix = new int[n][m];
        for (int i = 0; i < matrix.length; i++) {
            for (int j = 0; j < matrix[i].length; j++) {
                int positiveNegative = Math.random()<0.5?-1:1;
    ...
    private static void task26() {
        ...
        int[][] square; int n;
        Scanner scanner = new Scanner(System.in);
        System.out.print("создание магического куба : "); n = scanner.nextInt();
        while(n < 3){
